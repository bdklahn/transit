...
class AnalysisMethod:
    ...
    def progress_update(self, text, count):
        # TODO: write docstring
        # Suppressing progress output because it takes too much space.
        return
        # if self.wxobj:
...
class MultiConditionMethod(AnalysisMethod):
    ...
    def filter_wigs_by_conditions(
        ...
        """
        ignored_conditions, included_conditions = (
    ...
    def select_conditions(
        self, conditions, included_conditions, ignored_conditions, orderingMetadata
    ):
